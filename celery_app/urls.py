...
from .views import Index, CreateAuction, RegisterUserView, Account_page, Reports, UserReports, Company, Contact
...
urlpatterns = [
    ...
    path('contact-us', Contact.as_view(), name='contact_page'),
